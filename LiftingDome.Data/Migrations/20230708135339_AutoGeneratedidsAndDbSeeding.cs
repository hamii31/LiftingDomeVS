...
namespace LiftingDome.Data.Migrations
{
    ...
    public partial class AutoGeneratedidsAndDbSeeding : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.InsertData(
                ...
                columns: new[] { "Id", "Name" },
                values: new object[] { 1, "Powerlifting" });

            migrationBuilder.InsertData(
                table: "WorkoutCategories",
                columns: new[] { "Id", "Name" },
                values: new object[] { 2, "Bodybuilding" });

            migrationBuilder.InsertData(
                table: "WorkoutCategories",
                columns: new[] { "Id", "Name" },
                values: new object[] { 3, "CrossFit" });
