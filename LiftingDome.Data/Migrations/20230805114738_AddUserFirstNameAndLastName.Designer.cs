...
namespace LiftingDome.Data.Migrations
{
    ...
    [Migration("20230805114738_AddUserFirstNameAndLastName")]
            ...
            modelBuilder.Entity("LiftingDome.Models.CoachCertificate", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("ad83339e-2549-456d-9aa7-17aecb195055"),
                            Name = "ACSM"
                        },
                        new
                        {
                            Id = new Guid("b7bfe2e5-5b81-4f8b-924e-5acabf6e3293"),
                            Name = "NSCA"
                        },
                        new
                        {
                            Id = new Guid("7fd764b9-5917-4a8e-8719-721d4835be37"),
                            Name = "NASM"
                        },
                        new
                        {
                            Id = new Guid("d666c902-59eb-4a3e-a54e-480f3a7335a2"),
                            Name = "ACE"
                        },
                        new
                        {
                            Id = new Guid("df58619f-af35-4579-803d-84134353516b"),
                            Name = "ISSA"
                        },
                        new
                        {
                            Id = new Guid("5c375165-f1a2-43b0-afbe-5cf79ddad74b"),
                            Name = "AFPA"
                        },
                        new
                        {
                            Id = new Guid("c2df4a2b-83fa-4b56-8292-6c231ea1ccc3"),
                            Name = "NFPT"
                        });
                });
            ...
            modelBuilder.Entity("LiftingDome.Models.ForumPost", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("c546297e-7cc1-4079-a626-7cf51ee054e8"),
                            CategoryId = 4,
                        ...
                        new
                        {
                            Id = new Guid("ff5c2ff5-4860-48da-a471-2913f89d1094"),
                            CategoryId = 1,
                            CreatedOn = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            HasBeenEdited = false,
                            IsActive = false,
            ...
            modelBuilder.Entity("LiftingDome.Models.Workout", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("58e9aba7-2892-49bd-a66e-9ae1b53599e1"),
                        ...
                        new
                        {
                            Id = new Guid("d162b16d-5d5c-40d2-8e1e-90dda1c202e4"),
                            CoachId = new Guid("09cd637a-3447-4f2f-bbf0-5ba9cb561209"),
                            CreatedOn = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            Id = new Guid("38ddb4e0-efec-49cb-923f-8f10ecc32f6a"),
                            CoachId = new Guid("09cd637a-3447-4f2f-bbf0-5ba9cb561209"),
                            CreatedOn = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            Id = new Guid("30ac8dde-9a5a-4cbe-b69b-0e79f18aac72"),
                            CoachId = new Guid("09cd637a-3447-4f2f-bbf0-5ba9cb561209"),
                            CreatedOn = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
